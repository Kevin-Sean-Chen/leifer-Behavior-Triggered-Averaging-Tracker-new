%make a histogram
N = transpose(hist3([transpose([Tracks.Speed]), transpose(abs([Tracks.AngSpeed]))], {0:.025:1,0:20:800})); %count up the frequencies for this bivariate histogram
...
set(gca, 'YTick',1:41,'YTickLabel',0:20:800)
xlabel('Speed (mm/s)')
